...
namespace server.JWT
{
    ...
    {
        IImmutableDictionary<string, RefreshToken> UserRefreshTokensReadOnlyDictionary { get; }
    ...
    {
        public IImmutableDictionary<string, RefreshToken> UserRefreshTokensReadOnlyDictionary => _usersRefreshTokens.ToImmutableDictionary();
    ...
    public class RefreshToken
    {
        ...
        public string UserName { get; set; } //can add other properties
